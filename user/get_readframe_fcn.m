  ...
  switch videofiletype,
    ...
    case 'SingleLarvaTracker',
     ...
     case 'poseNetHeatmap' %not a video but a heatmap generated by poseNet. Heatmap is in the variable 'scores'
        ...
        pt2disp = 1; %scores contains heatmaps for all points. Can only display one at time.  This specifies which point.  Initializing for point 1.
        readframe = @(f) squeeze(HMmatObj.scores(f,:,:,pt2disp)); 
        headerinfo = struct('nr',nr,'nc',nc,'nframes',nframes,'pointDisplayed',pt2disp,'type','poseNetHeatmap');
    otherwise
